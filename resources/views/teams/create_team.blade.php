        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title float-left">
                    <h3 class="m-portlet__head-text">Create Team</h3>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" value="" id="title" placeholder="Enter Title.." required>
                        </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <select class="form-control select2" name="department_id" id="team_type_id" required>
                            ...
                            @foreach($types as $type)
                                <option value="{{$type->department_id }}"> {{$type->title}}  </option>
                            @endforeach
                        </select>
                    </div>
