...
@section('content')
    ...
    <div class="modal fade show"  id="did_form_modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="preview_files_modalLabel" aria-hidden="true">
        <div class="modal-dialog disposition_type_modal" >
