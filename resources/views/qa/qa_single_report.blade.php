...
<div id="lead_print" style="overflow-y: scroll; height: 500px; overflow-x: hidden;">
    <h3 CLASS="text-center">QA Report</h3><br>
{{--    @if($lead_data->disposition_type == 1)--}}
       <table class="table table-bordered table-striped">
           ...
           <tr>
               <td>{{$qa_data->agent->full_name}}</td>
               <td>{{ $qa_data->call_type->title }}</td>
               <td>{{ $qa_data->call_number }}</td>
           </tr>

       @if($qa_data->call_type_id == 1)
               <tr>
                   <th>Order Number</th>
               ...
               <tr>
                   <td>{{$qa_data->call_disposition->order_number}}</td>
                   <td>{{$qa_data->call_disposition->order_confirmation_number}}</td>
                   <td>{{$qa_data->call_disposition->account}}</td>
               </tr>
               @endif
           <tr>
           ...
           <tr>
               ...
               <td>{{$qa_data->call_disposition->customer_name}}</td>
               <td>{{$qa_data->call_date}}</td>
               <td>{{$qa_data->added_on}}</td>
           ...
           <tr>
               <td>{{$qa_data->monitor_percentage}}</td>
           </tr>
