    ...
    <div class="m-portlet">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h6 class="m-portlet__head-text">
                        ...
                        @elseif($is_manager && ($EmployeeAssessment == true || $initiated_employee_assessment == true))
                            Department Head/Supervisor Evaluation and Remarks
                        @elseif( ($EmployeeAssessment == false && ($is_employee || $is_manager || $is_hrm)) || $initiated_employee_assessment == true )
        ...
        <div class="m-portlet__body">
            ...
            <form id="employee_assessment_form" action="javascript:save_employee_assessment()" method="post" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                ...
                @if(($is_employee || $is_manager || $is_hrm) && ($EmployeeAssessment == false || $initiated_employee_assessment == true ))
                    @include('employee_assessment.partials.employee_assessment_employee_form')
                @endif
                @if( ( ($is_admin || ($EmployeeAssessment && $EmployeeAssessment->employees->employee->manager_id == Auth::user()->user_id)) && $EmployeeAssessment->manager_sign == 0)  && $EmployeeAssessment == true)
                                ...
                                <div class="{{( ($EmployeeAssessment == true && ( ($is_admin && $EmployeeAssessment->manager_sign == 1) || $is_hrm )) ? 'col-9 pe-0 pr-0' : 'col-12' )}}">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            @php
                                                $check = (!$is_admin OR ($is_admin && $EmployeeAssessment->evaluation_standards[0]->remarker_id != Auth::user()->user_id)) and $EmployeeAssessment and count($EmployeeAssessment->evaluation_standards) > 0;
                                            @endphp
                                            <tr>
