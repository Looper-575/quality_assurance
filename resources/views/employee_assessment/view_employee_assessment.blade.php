        ...
        <div class="m-portlet__body">
            ...
            <div class="row mb-2">
                ...
                <div class="col-4">
                    ...
                    <span class="font-bold font-12">{{ $EmployeeAssessment->from_date }} - {{ $EmployeeAssessment->to_date }}</span>
                </div>
                <div class="col-4">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="text-align: center;">
                                                ...
                                                @if($employee_self_evaluation->supervision !=null)
                                                <tr>
                                                ...
                                                @endif
                                                @if($employee_self_evaluation->leadership !=null)
                                                <tr>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="text-align: center;">
                                                ...
                                                @if($employee_self_evaluation->coaching !=null)
                                                <tr>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @if(($is_manager && $employee_manager_evaluation && $employee_manager_evaluation->remarker_id == Auth::user()->user_id) || $is_hrm || $is_admin)
                        <div class="row">
                        <div class="col-12">
