        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">QA Average Report Form</h3>
                </div>
            </div>
        </div>
...
@section('footer_scripts')
    ...
    <script>
        $('#report_form').submit(function (e) {
            ...
            let arr = [a];
            call_ajax_with_functions('qa_avg_report_data', '{{route('generate_qa_avg_report')}}', data, arr);
        });
        function view_qa(me) {
