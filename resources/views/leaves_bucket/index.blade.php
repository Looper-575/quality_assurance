        ...
        <div class="m-portlet__body">
            <table class="datatable table table-bordered" style="">
                ...
                <tr>
                    ...
                    <th title="Field #2">Start Date</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{route('view_leaves_bucket',['bucket_id' => $bucket->bucket_id])}}" id="{{$bucket->bucket_id}}" class="btn btn-primary"><i class="la la-eye"></i></a>
                                    @if($is_admin || $is_hr)
