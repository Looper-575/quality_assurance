this.Element && function (t) {
    ...
    window.requestAnimationFrame || (window.requestAnimationFrame = function (t) {
        var e = (new Date).getTime(), a = Math.max(0, 16 - (e - o)), n = window.setTimeout(function () {
            t(e + a)
        }, a);
        return o = e + a, n
    ...
    t.hasOwnProperty("prepend") || Object.defineProperty(t, "prepend", {
        ...
        writable: !0,
        value: function () {
            var t = Array.prototype.slice.call(arguments), a = document.createDocumentFragment();
...
var mUtil = function () {
    var e = [], a = {sm: 544, md: 768, lg: 1024, xl: 1200}, n = function () {
        var t = !1;
    ...
    return {
        init: function (t) {
            ...
            if (t && void 0 !== e) {
                var a = e.split(" ");
                if (t.classList) for (var n = 0; n < a.length; n++) a[n] && 0 < a[n].length && t.classList.add(mUtil.trim(a[n])); else if (!mUtil.hasClass(t, e)) for (n = 0; n < a.length; n++) t.className += " " + mUtil.trim(a[n])
            }
            ...
            if (t = mUtil.get(t), void 0 !== a) t.style[e] = a; else {
...
$(document).ready(function () {
    ...
    g.fn.mDatatable = function (u) {
        if (0 !== g(this).length) {
            ...
            p.debug = !1;
            var f = {
                isInit: !(p.API = {record: null, value: null, params: null}),
                offset: 110,
                stateId: "meta",
                ajaxParams: {},
                init: function (t) {
                ...
                extractTable: function () {
                    var i = [], n = g(p).find("tr:first-child th").get().map(function (t, e) {
                ...
                layoutUpdate: function () {
                    f.setupSubDatatable.call(), f.setupSystemColumn.call(), f.setupHover.call(), void 0 === u.detail && 1 === f.getDepth() && f.lockTable.call(), f.columnHide.call(), f.resetScroll(), f.isInit || (g(p).trigger("m-datatable--on-init", {
                        ...
                        options: u
                    }), f.isInit = !0), g(p).trigger("m-datatable--on-layout-updated", {table: g(p.wrap).attr("id")})
                },
                lockTable: function () {
                    var e = {
                        lockEnabled: !1, init: function () {
                            ...
                            g(p.table).find("thead,tbody,tfoot").each(function () {
                                ...
                                0 === g(this).find(".m-datatable__lock").length && g(this).ready(function () {
                                    !function (t) {
                                        if (0 < g(t).find(".m-datatable__lock").length) f.log("Locked container already exist in: ", t); else if (0 !== g(t).find(".m-datatable__row").length) {
                ...
                lockEnabledColumns: function () {
                    var a = g(window).width(), t = u.columns, n = {left: [], right: []};
                ...
                adjustLockContainer: function () {
                    ...
                    var t = g(p.tableHead).width(), e = g(p.tableHead).find(".m-datatable__lock--left").width(),
                ...
                dragResize: function () {
                    ...
                    g(p.tableHead).find(".m-datatable__cell").mousedown(function (t) {
                        ...
                        if (r) {
                            var n = g(s).index(), t = g(p.tableBody), e = g(s).closest(".m-datatable__lock");
                            if (e) {
                                var o = g(e).index();
                ...
                initHeight: function () {
                    if (u.layout.height && u.layout.scroll) {
                        var t = g(p.tableHead).find(".m-datatable__row").height(),
                            e = g(p.tableFoot).find(".m-datatable__row").height(), a = u.layout.height;
                ...
                setupTemplateCell: function (t) {
                    ...
                    g(t).find(".m-datatable__row").each(function (i, t) {
                        var l = g(t).data("obj") || {}, e = f.getOption("rows.callback");
                ...
                scrollbar: function () {
                    var n = {
                        ...
                        onScrolling: function (t) {
                            var e = g(this).scrollLeft(), a = g(this).scrollTop();
                ...
                setHeadTitle: function (t) {
                    ...
                    var e = u.columns, o = t.getElementsByTagName("tr")[0], i = t.getElementsByTagName("td");
                ...
                dataRender: function (t) {
                    ...
                    var n = function () {
                        ...
                        var e = Math.max(t.perpage * (t.page - 1), 0), a = Math.min(e + t.perpage, t.total);
                        ...
                        var e = function (e, a) {
                            ...
                            var t = Math.max(a.perpage * (a.page - 1), 0), n = Math.min(t + a.perpage, a.total);
                            f.localDataUpdate(), p.dataSet = g(p.dataSet).slice(t, n), f.insertData()
                        };
                        if (g(p.wrap).removeClass("m-datatable--error"), u.pagination) if (u.data.serverPaging && "local" !== u.data.type) {
                            var a = f.getObject("meta", t || null);
                            null !== a ? f.paging(a) : f.paging(n(), e)
                        } else f.paging(n(), e); else f.localDataUpdate();
                        f.insertData()
                    };
                ...
                insertData: function () {
                    p.dataSet = p.dataSet || [];
                    var s = f.getDataSourceParam(), t = s.pagination, e = (Math.max(t.page, 1) - 1) * t.perpage,
                        a = Math.min(t.page, t.pages) * t.perpage, d = {};
                    ...
                    var m = {
                        ...
                        populate: function () {
                            ...
                            0 == d.length && (d = [10, 20, 30, 50, 100]), g.each(d, function (t, e) {
                                var a = e;
                                -1 === e && (a = "All"), g("<option/>").attr("value", e).html(a).appendTo(s)
                            }), g(p).ready(function () {
                        ...
                        updatePerpage: function (t) {
                            t.preventDefault(), null === f.getOption("layout.height") && g("html, body").animate({scrollTop: g(p).position().top}), m.pager = g(p.table).siblings(".m-datatable__pager").removeClass("m-datatable--paging-loaded"), t.originalEvent && (m.meta.perpage = parseInt(g(this).val())), g(m.pager).find("select.m-datatable__pager-size").val(m.meta.perpage).attr("data-selected", m.meta.perpage), f.setDataSourceParam("pagination", {
                                page: m.meta.page,
                                pages: m.meta.pages,
                                perpage: m.meta.perpage,
                                total: m.meta.total
                        ...
                        pagingBreakpoint: function () {
                            ...
                            if (0 !== g(a).length) {
                                var n = f.getCurrentPage(), o = g(a).find(".m-pager-input").closest("li");
                ...
                columnHide: function () {
                    ...
                    g.each(u.columns, function (t, e) {
                        if (void 0 !== e.responsive) {
                            var a = e.field, n = g.grep(g(p.table).find(".m-datatable__cell"), function (t, e) {
                ...
                setupSubDatatable: function () {
                    ...
                    if ("function" == typeof l && !(0 < g(p.table).find(".m-datatable__subtable").length)) {
                        ...
                        var o = function (a) {
                            a.preventDefault();
                            var t = g(this).closest(".m-datatable__row"), e = g(t).next(".m-datatable__row-subtable");
                ...
                sortCallback: function (t, i, e) {
                    var l = e.type || "string", r = e.format || "", s = e.field;
                ...
                autoHide: function () {
                    ...
                    var t = function (t) {
                        t.preventDefault();
                        var e = g(this).closest(".m-datatable__row"), a = g(e).next();
                        if (g(a).hasClass("m-datatable__row-detail")) g(this).find("i").removeClass(f.getOption("layout.icons.rowDetail.expand")).addClass(f.getOption("layout.icons.rowDetail.collapse")), g(a).remove(); else {
                            ...
                            var o = g("<td/>").addClass("m-datatable__detail").attr("colspan", f.getTotalColumns()).appendTo(a),
                                i = g("<table/>");
                            g(n).each(function () {
                                var a = g(this).data("field"), t = g.grep(u.columns, function (t, e) {
                                    return a === t.field
                                })[0];
                ...
                hasOverflowY: function (t) {
                    var e = g(t).find(".m-datatable__row"), a = 0;
                ...
                sortColumn: function (t, o, i) {
                    ...
                    var l = g(t).index(), e = g(p.tableBody).find(".m-datatable__row"),
                        ...
                        init: function () {
                            ...
                            if (!g.isEmptyObject(t)) {
                                var e = g(p.tableHead).find('.m-datatable__cell[data-field="' + t.field + '"]').attr("data-sort", t.sort),
                                    a = g(e).find("span"), n = g(a).find("i"), o = f.getOption("layout.icons.sort");
                                0 < g(n).length ? g(n).removeAttr("class").addClass(o[t.sort]) : g(a).append(g("<i/>").addClass(o[t.sort]))
                            }
                        }, sortClick: function (t) {
                            var e = f.getDataSourceParam("sort"), a = g(this).data("field"), n = f.getColumnByField(a);
                ...
                localDataUpdate: function () {
                    ...
                    var t = f.getObject("sort.field", a), e = f.getObject("sort.sort", a), n = f.getColumnByField(t);
                ...
                setDataSourceParam: function (t, e) {
                    p.API.params = g.extend({}, {
                        pagination: {page: 1, perpage: f.getOption("data.pageSize")},
                ...
                hideColumn: function (a) {
                    g.map(u.columns, function (t) {
                        return a === t.field && (t.responsive = {hidden: "xl"}), t
                    });
                ...
                visible: function (t) {
                    if (g(f.recentNode.length)) {
                        ...
                        t ? (f.recentNode === f.nodeCols && delete u.columns[a].responsive, g(f.recentNode).show()) : (f.recentNode === f.nodeCols && f.setOption("columns." + a + ".responsive", {hidden: "xl"}), g(f.recentNode).hide()), f.redraw()
                    }
                },
                nodes: function () {
                    return f.recentNode
            ...
            }, u = g.extend(!0, {}, g.fn.mDatatable.defaults, u), p.options = u, f.init.apply(this, [u]), g(p.wrap).data("mDatatable", p)); else void 0 === (p = g(this).data("mDatatable")) && g.error("mDatatable not initialized"), u = p.options;
            return p
        }
...
var mDropdown = function (t, e) {
    var o = this, n = mUtil.get(t), i = mUtil.get("body");
    if (n) {
        var a = {
            toggle: "click",
            hoverTimeout: 300,
            ...
            construct: function (t) {
                ...
                var t = mUtil.outerWidth(n),
                    e = mUtil.hasClass(o.layout.arrow, "m-dropdown__arrow--right") ? "right" : "left", a = 0;
...
var mHeader = function (t, e) {
    var i = this, a = mUtil.get(t), l = mUtil.get("body");
    if (void 0 !== a) {
    ...
    var p = this, a = !1, d = mUtil.get(t), i = mUtil.get("body");
    if (d) {
        var n = {
            ...
            construct: function (t) {
                ...
                if (!1 !== p.resumeDropdownHover() && "accordion" !== f.getSubmenuMode()) {
                    var e = this, a = p.options.dropdown.timeout, n = setTimeout(function () {
                ...
                if ("accordion" !== f.getSubmenuMode()) {
                    ...
                    if (0 < a.length && !1 === mUtil.hasClass(e, "m-menu__toggle") && 0 === e.querySelectorAll(".m-menu__toggle").length) for (var n = 0, o = a.length; n < o; n++) f.hideSubmenuDropdown(a[0], !0)
                }
            }, handleSubmenuAccordion: function (t, e) {
                var a, n = e || this;
                if ("dropdown" === f.getSubmenuMode() && (a = n.closest(".m-menu__item")) && "accordion" != a.getAttribute("m-menu-submenu-mode")) t.preventDefault(); else {
                ...
                if (!1 === p.options.accordion.expandAll && (e = d.querySelectorAll(".m-menu__item--open"))) for (n = 0, o = e.length; n < o; n++) mUtil.removeClass(a[0], "m-menu__item--open")
...
var mOffcanvas = function (t, e) {
    var l = this, a = mUtil.get(t), n = mUtil.get("body");
    if (a) {
        var o = {}, i = {
            construct: function (t) {
                ...
                if (l.options.toggleBy) if ("string" == typeof l.options.toggleBy) mUtil.addEvent(l.options.toggleBy, "click", i.toggle); else if (l.options.toggleBy && l.options.toggleBy[0] && l.options.toggleBy[0].target) for (var t in l.options.toggleBy) mUtil.addEvent(l.options.toggleBy[t].target, "click", i.toggle); else l.options.toggleBy && l.options.toggleBy.target && mUtil.addEvent(l.options.toggleBy.target, "click", i.toggle);
    ...
    var s = this, d = mUtil.get(t), c = mUtil.get("body");
    if (d) {
        var a = {
            bodyToggleSpeed: 400,
            tooltips: !0,
            ...
            construct: function (t) {
                ...
                if (s.options.tooltips) {
                    ...
                    if (a) {
                        var n = e ? "bottom" : "top", o = new Tooltip(a, {
                ...
                if ("off" === t || mUtil.hasClass(c, "m-portlet--fullscreen") && mUtil.hasClass(d, "m-portlet--fullscreen")) o.eventTrigger("beforeFullscreenOff"), mUtil.removeClass(c, "m-portlet--fullscreen"), mUtil.removeClass(d, "m-portlet--fullscreen"), o.removeTooltips(), o.setupTooltips(), s.foot && (mUtil.css(s.body, "margin-bottom", ""), mUtil.css(s.foot, "margin-top", "")), o.eventTrigger("afterFullscreenOff"); else {
                ...
                return s.events.push({name: t, handler: e, one: a, fired: !1}), s
            }
        };
    ...
    var n = this, a = mUtil.get(t), o = mUtil.get("body");
    if (a) {
        var l = {
            mode: "default",
            minLength: 1,
    ...
    var o = this, a = mUtil.get(t), n = mUtil.get("body");
    if (a) {
        ...
        var a = {startStep: 1, manualStepForward: !1}, r = {
            construct: function (t) {
                ...
                mUtil.addEvent(l.btnNext, "click", function (t) {
                    ...
                    for (var t, e = this.closest(".m-wizard__step"), a = mUtil.parents(this, ".m-wizard__steps"), n = mUtil.findAll(a, ".m-wizard__step"), o = 0, i = n.length; o < i; o++) if (e === n[o]) {
                        t = o + 1;
                        break
                    }
                ...
                if (l.progress) if (mUtil.hasClass(o, "m-wizard--1")) {
                    var t = l.currentStep / l.totalSteps * 100, e = mUtil.find(o, ".m-wizard__step-number"),
                ...
                var t = l.steps[l.currentStep - 1], e = mUtil.get(mUtil.attr(t, "m-wizard-target")),
                ...
                return l.events.push({name: t, handler: e, one: a, fired: !1}), l
            }
        };
        return l.setDefaults = function (t) {
            a = t
...
$.notifyDefaults({template: '<div data-notify="container" class="alert alert-{0} m-alert" role="alert"><button type="button" aria-hidden="true" class="close" data-notify="dismiss"></button><span data-notify="icon"></span><span data-notify="title">{1}</span><span data-notify="message">{2}</span><div class="progress" data-notify="progressbar"><div class="progress-bar progress-bar-animated bg-{0}" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"></div></div><a href="{3}" target="{4}" data-notify="url"></a></div>'}), swal.setDefaults({
    ...
    var t, e, a, n, o, i, l, r = this._chart.ctx, s = this._view, d = s.borderWidth,
    ...
    if (s.horizontal ? (t = s.base, e = s.x, a = s.y - s.height / 2, n = s.y + s.height / 2, o = t < e ? 1 : -1, i = 1, l = s.borderSkipped || "left") : (t = s.x - s.width / 2, e = s.x + s.width / 2, o = 1, i = (a = s.y > 2 * c ? s.y - c : s.y) < (n = s.base) ? 1 : -1, l = s.borderSkipped || "bottom"), d) {
        var m = Math.min(Math.abs(t - e), Math.abs(a - n)), u = (d = m < d ? m : d) / 2,
            p = t + ("left" !== l ? u * o : 0), f = e + ("right" !== l ? -u * o : 0), g = a + ("top" !== l ? u * i : 0),
            h = n + ("bottom" !== l ? -u * i : 0);
        p !== f && (a = g, n = h), g !== h && (t = p, e = f)
    }
    r.beginPath(), r.fillStyle = s.backgroundColor, r.strokeStyle = s.borderColor, r.lineWidth = d;
    var b = [[t, n], [t, a], [e, a], [e, n]], v = ["bottom", "left", "top", "right"].indexOf(l, 0);
...
}, "Please enter a valid Email."), function (l) {
    ...
    return {
        init: function () {
            ...
            t = mUtil.get("m_aside_left"), e = mUtil.hasClass(t, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", a = new mOffcanvas("m_aside_left", {
                ...
                var t = $("#m_ver_menu"), e = "1" === t.data("m-menu-dropdown") ? "dropdown" : "accordion";
...
var mQuickSidebar = function () {
    var n = $("#m_quick_sidebar"), o = $("#m_quick_sidebar_tabs"), t = n.find(".m-quick-sidebar__content"),
        e = function () {
            !function () {
                var e = $("#m_quick_sidebar_tabs_messenger");
                if (0 !== e.length) {
                    var a = e.find(".m-messenger__messages"), t = function () {
